##R file to create the Plot 4 in Exploratory Data Analysis - Assignment 1
...
par(mfrow = c(2, 2))
	#1 plot
		plot(fpc$dttm, fpc$Global_active_power,"l",xlab = "",ylab = "Golbal Active Power")
	#2nd plot
		plot(fpc$dttm, fpc$Voltage,"l",ylab = "Voltage", xlab="datetime")
...
#4th plot
	plot(fpc$dttm, fpc$Global_reactive_power,"l",ylab = "Global_reactive_power", xlab="datetime")
